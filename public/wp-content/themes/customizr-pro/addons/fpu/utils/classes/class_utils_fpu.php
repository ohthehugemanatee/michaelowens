...
* @link         http://www.themesandco.com/extension/featured-pages-unlimited/
...
class TC_utils_fpu {
    ...
    */
    function tc_fpc_get_option( $option_name , $option_group = null ) {
      ...
      return apply_filters( 'tc_fpc_get_option' , $returned_option , $option_name , $option_group );
    }
    ...
    function tc_get_theme_config( $what = 'hook_list' ) {
     ...
     function tc_get_custom_fp_nb() {
        ...
        $fp_nb                                  = isset($tc_options['tc_fp_number']) ? $tc_options['tc_fp_number'] : 3;
