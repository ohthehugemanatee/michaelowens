###################### Copyright ######################
WordPress Font Customizer is a WordPress plugin designed and developed by Nicolas Guillaume (nikeo) in Nice, France (www.themesandco.com), and distributed under the terms of the GNU GPL v2.0 or later.
Enjoy it!
...
DOCUMENTATION : http://www.themesandco.com/extension/wordpress-font-customizer/
...
* (css, php:class_dyn_style.php) fix the first letter issue in the menu (reported here http://themesandco.com/support-forums/topic/help-header-menu-font/)
